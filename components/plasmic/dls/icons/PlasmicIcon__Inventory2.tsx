...
export type Inventory2IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Inventory2Icon(props: Inventory2IconProps) {
  ...
  return (
    ...
    >
      ...
      <path d={"M15 12H9v2h6v-2z"} fill={"currentColor"}></path>
    </svg>
  );
}
