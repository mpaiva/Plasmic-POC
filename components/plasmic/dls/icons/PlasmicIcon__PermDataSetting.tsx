...
export type PermDataSettingIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function PermDataSettingIcon(props: PermDataSettingIconProps) {
