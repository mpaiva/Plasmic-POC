...
export type _3DRotationIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function _3DRotationIcon(props: _3DRotationIconProps) {
